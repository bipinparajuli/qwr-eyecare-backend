...
const encryptStringCrypt = function(string_value){
  let encryptedString = cryptr.encrypt(string_value);
  return encryptedString;
};

const decryptStringCrypt = function(string_value){
...
module.exports = {
  ...
  encryptStringCrypt:encryptStringCrypt,
  decryptStringCrypt:decryptStringCrypt,
